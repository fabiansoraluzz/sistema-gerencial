...
public class CrearCuentaPorPagarValidator
    : AbstractValidator<CrearCuentaPorPagarCommand>
{
    public CrearCuentaPorPagarValidator()
    {
        ...
        RuleFor(x => x.TipoContacto)
            ...
            .Must(t => new[]
            {
                "proveedor","empresa","persona","otro"
            }.Contains(t))
