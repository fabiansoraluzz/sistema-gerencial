...
{
    /// <inheritdoc />
    public partial class AddUsuariosYRoles : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstaDeAcuerdoPolitica = table.Column<bool>(type: "boolean", nullable: false),
                    FechaAcuerdoPolitica = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    TfaSecret = table.Column<string>(type: "text", nullable: true),
                    TfaHabilitado = table.Column<bool>(type: "boolean", nullable: false),
                    CreadoEn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ActualizadoEn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EliminadoEn = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
